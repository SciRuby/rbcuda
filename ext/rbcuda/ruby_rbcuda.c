...
void Init_rbcuda() {
  ...
  rb_define_singleton_method(CUDA, "cuDriverGetVersion", (METHOD)rb_cuDriverGetVersion, 1);
  ...
  rb_define_singleton_method(CUDA, "cuDeviceGetAttribute", (METHOD)rb_cuDeviceGetAttribute, 3);
  rb_define_singleton_method(CUDA, "cuDeviceGetProperties", (METHOD)rb_cuDeviceGetProperties, 1);
  rb_define_singleton_method(CUDA, "cuDeviceComputeCapability", (METHOD)rb_cuDeviceComputeCapability, 1);
  rb_define_singleton_method(CUDA, "cuDevicePrimaryCtxRetain", (METHOD)rb_cuDevicePrimaryCtxRetain, 1);
  rb_define_singleton_method(CUDA, "cuDevicePrimaryCtxRelease", (METHOD)rb_cuDevicePrimaryCtxRelease, 1);
  rb_define_singleton_method(CUDA, "cuDevicePrimaryCtxSetFlags", (METHOD)rb_cuDevicePrimaryCtxSetFlags, 2);
  rb_define_singleton_method(CUDA, "cuDevicePrimaryCtxGetState", (METHOD)rb_cuDevicePrimaryCtxGetState, 1);
  rb_define_singleton_method(CUDA, "cuDevicePrimaryCtxReset", (METHOD)rb_cuDevicePrimaryCtxReset, 1);
  rb_define_singleton_method(CUDA, "cuCtxCreate_v2", (METHOD)rb_cuCtxCreate_v2, 2);
  rb_define_singleton_method(CUDA, "cuCtxDestroy_v2", (METHOD)rb_cuCtxDestroy_v2, 1);
  rb_define_singleton_method(CUDA, "cuCtxPushCurrent_v2", (METHOD)rb_cuCtxPushCurrent_v2, 1);
  rb_define_singleton_method(CUDA, "cuCtxPopCurrent_v2", (METHOD)rb_cuCtxPopCurrent_v2, 0);
  rb_define_singleton_method(CUDA, "cuCtxSetCurrent", (METHOD)rb_cuCtxSetCurrent, 1);
  ...
  rb_define_singleton_method(CUDA, "cuCtxSetLimit", (METHOD)rb_cuCtxSetLimit, 2);
  rb_define_singleton_method(CUDA, "cuCtxGetLimit", (METHOD)rb_cuCtxGetLimit, 1);
  rb_define_singleton_method(CUDA, "cuCtxGetCacheConfig", (METHOD)rb_cuCtxGetCacheConfig, 0);
  rb_define_singleton_method(CUDA, "cuCtxSetCacheConfig", (METHOD)rb_cuCtxSetCacheConfig, 1);
  rb_define_singleton_method(CUDA, "cuCtxGetSharedMemConfig", (METHOD)rb_cuCtxGetSharedMemConfig, 0);
  rb_define_singleton_method(CUDA, "cuCtxSetSharedMemConfig", (METHOD)rb_cuCtxSetSharedMemConfig, 1);
  rb_define_singleton_method(CUDA, "cuCtxGetApiVersion", (METHOD)rb_cuCtxGetApiVersion, 1);
  rb_define_singleton_method(CUDA, "cuCtxGetStreamPriorityRange", (METHOD)rb_cuCtxGetStreamPriorityRange, 0);
  rb_define_singleton_method(CUDA, "cuCtxAttach", (METHOD)rb_cuCtxAttach, 1);
  rb_define_singleton_method(CUDA, "cuCtxDetach", (METHOD)rb_cuCtxDetach, 1);
  rb_define_singleton_method(CUDA, "cuModuleLoad", (METHOD)rb_cuModuleLoad, 1);
  rb_define_singleton_method(CUDA, "cuModuleLoadData", (METHOD)rb_cuModuleLoadData, 1);
  rb_define_singleton_method(CUDA, "cuModuleLoadDataEx", (METHOD)rb_cuModuleLoadDataEx, 4);
  rb_define_singleton_method(CUDA, "cuModuleLoadFatBinary", (METHOD)rb_cuModuleLoadFatBinary, 1);
  rb_define_singleton_method(CUDA, "cuModuleUnload", (METHOD)rb_cuModuleUnload, 1);
  rb_define_singleton_method(CUDA, "cuModuleGetFunction", (METHOD)rb_cuModuleGetFunction, 2);
  rb_define_singleton_method(CUDA, "cuModuleGetGlobal_v2", (METHOD)rb_cuModuleGetGlobal_v2, 2);
  rb_define_singleton_method(CUDA, "cuModuleGetTexRef", (METHOD)rb_cuModuleGetTexRef, 2);
  rb_define_singleton_method(CUDA, "cuModuleGetSurfRef", (METHOD)rb_cuModuleGetSurfRef, 2);
  rb_define_singleton_method(CUDA, "cuLinkCreate_v2", (METHOD)rb_cuLinkCreate_v2, 3);
  rb_define_singleton_method(CUDA, "cuLinkAddData_v2", (METHOD)rb_cuLinkAddData_v2, 8);
  rb_define_singleton_method(CUDA, "cuLinkAddFile_v2", (METHOD)rb_cuLinkAddFile_v2, 6);
  rb_define_singleton_method(CUDA, "cuLinkComplete", (METHOD)rb_cuLinkComplete, 1);
  rb_define_singleton_method(CUDA, "cuLinkDestroy", (METHOD)rb_cuLinkDestroy, 1);
  rb_define_singleton_method(CUDA, "cuMemGetInfo_v2", (METHOD)rb_cuMemGetInfo_v2, 0);
  rb_define_singleton_method(CUDA, "cuMemAlloc_v2", (METHOD)rb_cuMemAlloc_v2, 1);
  rb_define_singleton_method(CUDA, "cuMemAllocPitch_v2", (METHOD)rb_cuMemAllocPitch_v2, 4);
  rb_define_singleton_method(CUDA, "cuMemFree_v2", (METHOD)rb_cuMemFree_v2, 1);
  rb_define_singleton_method(CUDA, "cuMemGetAddressRange_v2", (METHOD)rb_cuMemGetAddressRange_v2, 1);
  rb_define_singleton_method(CUDA, "cuMemAllocHost_v2", (METHOD)rb_cuMemAllocHost_v2, 1);
  rb_define_singleton_method(CUDA, "cuMemFreeHost", (METHOD)rb_cuMemFreeHost, 1);
  rb_define_singleton_method(CUDA, "cuMemHostAlloc", (METHOD)rb_cuMemHostAlloc, 2);
  rb_define_singleton_method(CUDA, "cuMemHostGetDevicePointer_v2", (METHOD)rb_cuMemHostGetDevicePointer_v2, 2);
  rb_define_singleton_method(CUDA, "cuMemHostGetFlags", (METHOD)rb_cuMemHostGetFlags, 1);
  rb_define_singleton_method(CUDA, "cuMemAllocManaged", (METHOD)rb_cuMemAllocManaged, 2);
  rb_define_singleton_method(CUDA, "cuDeviceGetByPCIBusId", (METHOD)rb_cuDeviceGetByPCIBusId, 1);
  rb_define_singleton_method(CUDA, "cuDeviceGetPCIBusId", (METHOD)rb_cuDeviceGetPCIBusId, 2);
  rb_define_singleton_method(CUDA, "cuIpcGetEventHandle", (METHOD)rb_cuIpcGetEventHandle, 1);
  rb_define_singleton_method(CUDA, "cuIpcOpenEventHandle", (METHOD)rb_cuIpcOpenEventHandle, 1);
  rb_define_singleton_method(CUDA, "cuIpcGetMemHandle", (METHOD)rb_cuIpcGetMemHandle, 1);
  rb_define_singleton_method(CUDA, "cuIpcOpenMemHandle", (METHOD)rb_cuIpcOpenMemHandle, 2);
  rb_define_singleton_method(CUDA, "cuIpcCloseMemHandle", (METHOD)rb_cuIpcCloseMemHandle, 1);
  rb_define_singleton_method(CUDA, "cuMemHostRegister_v2", (METHOD)rb_cuMemHostRegister_v2, 3);
  rb_define_singleton_method(CUDA, "cuMemHostUnregister", (METHOD)rb_cuMemHostUnregister, 1);
  rb_define_singleton_method(CUDA, "cuMemcpy", (METHOD)rb_cuMemcpy, 3);
  rb_define_singleton_method(CUDA, "cuMemcpyPeer", (METHOD)rb_cuMemcpyPeer, 5);
  rb_define_singleton_method(CUDA, "cuMemcpyHtoD_v2", (METHOD)rb_cuMemcpyHtoD_v2, 3);
  rb_define_singleton_method(CUDA, "cuMemcpyDtoH_v2", (METHOD)rb_cuMemcpyDtoH_v2, 3);
  rb_define_singleton_method(CUDA, "cuMemcpyDtoD_v2", (METHOD)rb_cuMemcpyDtoD_v2, 3);
  rb_define_singleton_method(CUDA, "cuMemcpyDtoA_v2", (METHOD)rb_cuMemcpyDtoA_v2, 4);
  rb_define_singleton_method(CUDA, "cuMemcpyAtoD_v2", (METHOD)rb_cuMemcpyAtoD_v2, 4);
  rb_define_singleton_method(CUDA, "cuMemcpyHtoA_v2", (METHOD)rb_cuMemcpyHtoA_v2, 4);
  rb_define_singleton_method(CUDA, "cuMemcpyAtoH_v2", (METHOD)rb_cuMemcpyAtoH_v2, 4);
  rb_define_singleton_method(CUDA, "cuMemcpyAtoA_v2", (METHOD)rb_cuMemcpyAtoA_v2, 5);
  rb_define_singleton_method(CUDA, "cuMemcpy2D_v2", (METHOD)rb_cuMemcpy2D_v2, 1);
  rb_define_singleton_method(CUDA, "cuMemcpy2DUnaligned_v2", (METHOD)rb_cuMemcpy2DUnaligned_v2, 1);
  rb_define_singleton_method(CUDA, "cuMemcpy3D_v2", (METHOD)rb_cuMemcpy3D_v2, 1);
  rb_define_singleton_method(CUDA, "cuMemcpy3DPeer", (METHOD)rb_cuMemcpy3DPeer, 1);
  rb_define_singleton_method(CUDA, "cuMemcpyAsync", (METHOD)rb_cuMemcpyAsync, 4);
  rb_define_singleton_method(CUDA, "cuMemcpyPeerAsync", (METHOD)rb_cuMemcpyPeerAsync, 6);
  rb_define_singleton_method(CUDA, "cuMemcpyHtoDAsync_v2", (METHOD)rb_cuMemcpyHtoDAsync_v2, 4);
  rb_define_singleton_method(CUDA, "cuMemcpyDtoHAsync_v2", (METHOD)rb_cuMemcpyDtoHAsync_v2, 4);
  rb_define_singleton_method(CUDA, "cuMemcpyDtoDAsync_v2", (METHOD)rb_cuMemcpyDtoDAsync_v2, 4);
  rb_define_singleton_method(CUDA, "cuMemcpyHtoAAsync_v2", (METHOD)rb_cuMemcpyHtoAAsync_v2, 5);
  rb_define_singleton_method(CUDA, "cuMemcpyAtoHAsync_v2", (METHOD)rb_cuMemcpyAtoHAsync_v2, 5);
  rb_define_singleton_method(CUDA, "cuMemcpy2DAsync_v2", (METHOD)rb_cuMemcpy2DAsync_v2, 2);
  rb_define_singleton_method(CUDA, "cuMemcpy3DAsync_v2", (METHOD)rb_cuMemcpy3DAsync_v2, 2);
  rb_define_singleton_method(CUDA, "cuMemcpy3DPeerAsync", (METHOD)rb_cuMemcpy3DPeerAsync, 2);
  rb_define_singleton_method(CUDA, "cuMemsetD8_v2", (METHOD)rb_cuMemsetD8_v2, 2);
  rb_define_singleton_method(CUDA, "cuMemsetD16_v2", (METHOD)rb_cuMemsetD16_v2, 2);
  rb_define_singleton_method(CUDA, "cuMemsetD32_v2", (METHOD)rb_cuMemsetD32_v2, 2);
  rb_define_singleton_method(CUDA, "cuMemsetD2D8_v2", (METHOD)rb_cuMemsetD2D8_v2, 5);
  rb_define_singleton_method(CUDA, "cuMemsetD2D16_v2", (METHOD)rb_cuMemsetD2D16_v2, 5);
  rb_define_singleton_method(CUDA, "cuMemsetD2D32_v2", (METHOD)rb_cuMemsetD2D32_v2, 5);
  rb_define_singleton_method(CUDA, "cuMemsetD8Async", (METHOD)rb_cuMemsetD8Async, 4);
  rb_define_singleton_method(CUDA, "cuMemsetD16Async", (METHOD)rb_cuMemsetD16Async, 4);
  rb_define_singleton_method(CUDA, "cuMemsetD32Async", (METHOD)rb_cuMemsetD32Async, 4);
  rb_define_singleton_method(CUDA, "cuMemsetD2D8Async", (METHOD)rb_cuMemsetD2D8Async, 6);
  rb_define_singleton_method(CUDA, "cuMemsetD2D16Async", (METHOD)rb_cuMemsetD2D16Async, 6);
  rb_define_singleton_method(CUDA, "cuMemsetD2D32Async", (METHOD)rb_cuMemsetD2D32Async, 6);
  ...
  rb_define_singleton_method(CUDA, "cuFuncGetAttribute", (METHOD)rb_cuFuncGetAttribute, 2);
  rb_define_singleton_method(CUDA, "cuFuncSetCacheConfig", (METHOD)rb_cuFuncSetCacheConfig, 2);
  rb_define_singleton_method(CUDA, "cuFuncSetSharedMemConfig", (METHOD)rb_cuFuncSetSharedMemConfig, 2);
  rb_define_singleton_method(CUDA, "cuLaunchKernel", (METHOD)rb_cuLaunchKernel, 11);
  rb_define_singleton_method(CUDA, "cuFuncSetBlockShape", (METHOD)rb_cuFuncSetBlockShape, 3);
  rb_define_singleton_method(CUDA, "cuFuncSetSharedSize", (METHOD)rb_cuFuncSetSharedSize, 2);
  rb_define_singleton_method(CUDA, "cuParamSetSize", (METHOD)rb_cuParamSetSize, 0);
  rb_define_singleton_method(CUDA, "cuParamSeti", (METHOD)rb_cuParamSeti, 3);
  rb_define_singleton_method(CUDA, "cuParamSetf", (METHOD)rb_cuParamSetf, 3);
  rb_define_singleton_method(CUDA, "cuParamSetv", (METHOD)rb_cuParamSetv, 4);
  rb_define_singleton_method(CUDA, "cuLaunch", (METHOD)rb_cuLaunch, 1);
  rb_define_singleton_method(CUDA, "cuLaunchGrid", (METHOD)rb_cuLaunchGrid, 3);
  rb_define_singleton_method(CUDA, "cuLaunchGridAsync", (METHOD)rb_cuLaunchGridAsync, 4);
  rb_define_singleton_method(CUDA, "cuParamSetTexRef", (METHOD)rb_cuParamSetTexRef, 4);
  rb_define_singleton_method(CUDA, "cuOccupancyMaxActiveBlocksPerMultiprocessor", (METHOD)rb_cuOccupancyMaxActiveBlocksPerMultiprocessor, 3);
  rb_define_singleton_method(CUDA, "cuOccupancyMaxActiveBlocksPerMultiprocessorWithFlags", (METHOD)rb_cuOccupancyMaxActiveBlocksPerMultiprocessorWithFlags, 4);
  rb_define_singleton_method(CUDA, "cuOccupancyMaxPotentialBlockSize", (METHOD)rb_cuOccupancyMaxPotentialBlockSize, 4);
  rb_define_singleton_method(CUDA, "cuOccupancyMaxPotentialBlockSizeWithFlags", (METHOD)rb_cuOccupancyMaxPotentialBlockSizeWithFlags, 5);
  ...
  rb_define_singleton_method(Runtime, "cudaDeviceSetLimit", (METHOD)rb_cudaDeviceSetLimit, 2);
  rb_define_singleton_method(Runtime, "cudaDeviceGetLimit", (METHOD)rb_cudaDeviceGetLimit, 2);
  ...
  rb_define_singleton_method(Runtime, "cudaDeviceSetCacheConfig", (METHOD)rb_cudaDeviceSetCacheConfig, 1);
  rb_define_singleton_method(Runtime, "cudaDeviceGetSharedMemConfig", (METHOD)rb_cudaDeviceGetSharedMemConfig, 0);
  rb_define_singleton_method(Runtime, "cudaDeviceSetSharedMemConfig", (METHOD)rb_cudaDeviceSetSharedMemConfig, 1);
  rb_define_singleton_method(Runtime, "cudaDeviceGetByPCIBusId", (METHOD)rb_cudaDeviceGetByPCIBusId, 1);
  rb_define_singleton_method(Runtime, "cudaDeviceGetPCIBusId", (METHOD)rb_cudaDeviceGetPCIBusId, 2);
  rb_define_singleton_method(Runtime, "cudaIpcGetEventHandle", (METHOD)rb_cudaIpcGetEventHandle, 1);
  rb_define_singleton_method(Runtime, "cudaIpcOpenEventHandle", (METHOD)rb_cudaIpcOpenEventHandle, 1);
  rb_define_singleton_method(Runtime, "cudaIpcGetMemHandle", (METHOD)rb_cudaIpcGetMemHandle, 2);
  rb_define_singleton_method(Runtime, "cudaIpcOpenMemHandle", (METHOD)rb_cudaIpcOpenMemHandle, 2);
  rb_define_singleton_method(Runtime, "cudaIpcCloseMemHandle", (METHOD)rb_cudaIpcCloseMemHandle, 1);
  ...
  rb_define_singleton_method(Runtime, "cudaThreadSetLimit", (METHOD)rb_cudaThreadSetLimit, 2);
  rb_define_singleton_method(Runtime, "cudaThreadGetLimit", (METHOD)rb_cudaThreadGetLimit, 1);
  rb_define_singleton_method(Runtime, "cudaThreadGetCacheConfig", (METHOD)rb_cudaThreadGetCacheConfig, 0);
  rb_define_singleton_method(Runtime, "cudaThreadSetCacheConfig", (METHOD)rb_cudaThreadSetCacheConfig, 1);
  ...
  rb_define_singleton_method(Runtime, "rb_cudaGetErrorName", (METHOD)rb_cudaGetErrorName, 1);
  rb_define_singleton_method(Runtime, "rb_cudaGetErrorString", (METHOD)rb_cudaGetErrorString, 1);
  rb_define_singleton_method(Runtime, "cudaGetDeviceCount", (METHOD)rb_cudaGetDeviceCount, 0);
  rb_define_singleton_method(Runtime, "cudaGetDeviceProperties", (METHOD)rb_cudaGetDeviceProperties, 1);
  rb_define_singleton_method(Runtime, "cudaDeviceGetAttribute", (METHOD)rb_cudaDeviceGetAttribute, 2);
  rb_define_singleton_method(Runtime, "cudaChooseDevice", (METHOD)rb_cudaChooseDevice, 0);
  rb_define_singleton_method(Runtime, "cudaSetDevice", (METHOD)rb_cudaSetDevice, 1);
  rb_define_singleton_method(Runtime, "cudaGetDevice", (METHOD)rb_cudaGetDevice, 0);
  rb_define_singleton_method(Runtime, "cudaSetValidDevices", (METHOD)rb_cudaSetValidDevices, 1);
  rb_define_singleton_method(Runtime, "cudaSetDeviceFlags", (METHOD)rb_cudaSetDeviceFlags, 1);
  ...
  rb_define_singleton_method(Runtime, "cudaStreamCreateWithFlags", (METHOD)rb_cudaStreamCreateWithFlags, 1);
  rb_define_singleton_method(Runtime, "cudaStreamCreateWithPriority", (METHOD)rb_cudaStreamCreateWithPriority, 2);
  rb_define_singleton_method(Runtime, "cudaStreamGetPriority", (METHOD)rb_cudaStreamGetPriority, 1);
  rb_define_singleton_method(Runtime, "cudaStreamGetFlags", (METHOD)rb_cudaStreamGetFlags, 1);
  rb_define_singleton_method(Runtime, "cudaStreamDestroy", (METHOD)rb_cudaStreamDestroy, 1);
  rb_define_singleton_method(Runtime, "cudaStreamWaitEvent", (METHOD)rb_cudaStreamWaitEvent, 3);
  rb_define_singleton_method(Runtime, "cudaStreamAddCallback", (METHOD)rb_cudaStreamAddCallback, 4);
  rb_define_singleton_method(Runtime, "cudaStreamSynchronize", (METHOD)rb_cudaStreamSynchronize, 1);
  rb_define_singleton_method(Runtime, "cudaStreamQuery", (METHOD)rb_cudaStreamQuery, 1);
  rb_define_singleton_method(Runtime, "cudaStreamAttachMemAsync", (METHOD)rb_cudaStreamAttachMemAsync, 1);
  rb_define_singleton_method(Runtime, "cudaEventCreate", (METHOD)rb_cudaEventCreate, 0);
  rb_define_singleton_method(Runtime, "cudaEventCreateWithFlags", (METHOD)rb_cudaEventCreateWithFlags, 1);
  rb_define_singleton_method(Runtime, "cudaEventRecord", (METHOD)rb_cudaEventRecord, 2);
  rb_define_singleton_method(Runtime, "cudaEventQuery", (METHOD)rb_cudaEventQuery, 1);
  rb_define_singleton_method(Runtime, "cudaEventSynchronize", (METHOD)rb_cudaEventSynchronize, 1);
  rb_define_singleton_method(Runtime, "cudaEventDestroy", (METHOD)rb_cudaEventDestroy, 1);
  rb_define_singleton_method(Runtime, "cudaEventElapsedTime", (METHOD)rb_cudaEventElapsedTime, 2);
  ...
  rb_define_singleton_method(Runtime, "cudaFuncSetSharedMemConfig", (METHOD)rb_cudaFuncSetSharedMemConfig, 2);
  ...
  rb_define_singleton_method(Runtime, "cudaOccupancyMaxActiveBlocksPerMultiprocessor", (METHOD)rb_cudaOccupancyMaxActiveBlocksPerMultiprocessor, 3);
  rb_define_singleton_method(Runtime, "cudaOccupancyMaxActiveBlocksPerMultiprocessorWithFlags", (METHOD)rb_cudaOccupancyMaxActiveBlocksPerMultiprocessorWithFlags, 4);
  ...
  rb_define_singleton_method(Runtime, "cudaLaunch", (METHOD)rb_cudaLaunch, 1);
  ...
  rb_define_singleton_method(Runtime, "cudaMallocPitch", (METHOD)rb_cudaMallocPitch, 3);
  ...
  rb_define_singleton_method(CuBLAS, "cublasAlloc", (METHOD)rb_cublasAlloc, 3);
  rb_define_singleton_method(CuBLAS, "cublasFree", (METHOD)rb_cublasFree, 1);
  rb_define_singleton_method(CuBLAS, "cublasSetKernelStream", (METHOD)rb_cublasSetKernelStream, 1);
  rb_define_singleton_method(CuBLAS, "cublasSnrm2", (METHOD)rb_cublasSnrm2, 0);
  rb_define_singleton_method(CuBLAS, "cublasDnrm2", (METHOD)rb_cublasDnrm2, 3);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDdot", (METHOD)rb_cublasDdot, 5);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDscal", (METHOD)rb_cublasDscal, 4);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDaxpy", (METHOD)rb_cublasDaxpy, 5);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDcopy", (METHOD)rb_cublasDcopy, 4);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDswap", (METHOD)rb_cublasDswap, 5);
  ...
  rb_define_singleton_method(CuBLAS, "cublasIdamax", (METHOD)rb_cublasIdamax, 3);
  ...
  rb_define_singleton_method(CuBLAS, "cublasIdamin", (METHOD)rb_cublasIdamin, 3);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDasum", (METHOD)rb_cublasDasum, 3);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDrot", (METHOD)rb_cublasDrot, 6);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDrotg", (METHOD)rb_cublasDrotg, 4);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDrotm", (METHOD)rb_cublasDrotm, 6);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDgemv", (METHOD)rb_cublasDgemv, 11);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDgbmv", (METHOD)rb_cublasDgbmv, 13);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDtrmv", (METHOD)rb_cublasDtrmv, 8);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDtbmv", (METHOD)rb_cublasDtbmv, 9);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDtpmv", (METHOD)rb_cublasDtpmv, 7);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDtrsv", (METHOD)rb_cublasDtrsv, 8);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDtpsv", (METHOD)rb_cublasDtpsv, 7);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDtbsv", (METHOD)rb_cublasDtbsv, 9);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDsymv", (METHOD)rb_cublasDsymv, 10);
  ...
  rb_define_singleton_method(CuBLAS, "cublasSsbmv", (METHOD)rb_cublasSsbmv, 10);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDspmv", (METHOD)rb_cublasDspmv, 9);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDger", (METHOD)rb_cublasDger, 9);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDsyr", (METHOD)rb_cublasDsyr, 7);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDspr", (METHOD)rb_cublasDspr, 6);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDsyr2", (METHOD)rb_cublasDsyr2, 9);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDspr2", (METHOD)rb_cublasDspr2, 8);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDgemm", (METHOD)rb_cublasDgemm, 13);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDsyrk", (METHOD)rb_cublasDsyrk, 10);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDsyr2k", (METHOD)rb_cublasDsyr2k, 12);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDsymm", (METHOD)rb_cublasDsymm, 12);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDtrsm", (METHOD)rb_cublasDtrsm, 11);
  ...
  rb_define_singleton_method(CuBLAS, "cublasDtrmm", (METHOD)rb_cublasDtrmm, 11);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasGetVersion_v2", (METHOD)rb_cublasGetVersion_v2, 1);
  rb_define_singleton_method(CuBLAS_v2, "cublasSetStream_v2", (METHOD)rb_cublasSetStream_v2, 2);
  rb_define_singleton_method(CuBLAS_v2, "cublasGetStream_v2", (METHOD)rb_cublasGetStream_v2, 1);
  rb_define_singleton_method(CuBLAS_v2, "cublasGetPointerMode_v2", (METHOD)rb_cublasGetPointerMode_v2, 1);
  rb_define_singleton_method(CuBLAS_v2, "cublasSetPointerMode_v2", (METHOD)rb_cublasSetPointerMode_v2, 2);
  rb_define_singleton_method(CuBLAS_v2, "cublasGetAtomicsMode", (METHOD)rb_cublasGetAtomicsMode, 1);
  rb_define_singleton_method(CuBLAS_v2, "cublasSetAtomicsMode", (METHOD)rb_cublasSetAtomicsMode, 2);
  rb_define_singleton_method(CuBLAS_v2, "cublasSetVector", (METHOD)rb_cublasSetVector, 1);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDaxpy_v2", (METHOD)rb_cublasDaxpy_v2, 7);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDcopy_v2", (METHOD)rb_cublasDcopy_v2, 6);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDswap_v2", (METHOD)rb_cublasDswap_v2, 6);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasIdamax_v2", (METHOD)rb_cublasIdamax_v2, 4);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasIdamin_v2", (METHOD)rb_cublasIdamin_v2, 4);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDasum_v2", (METHOD)rb_cublasDasum_v2, 4);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDrotg_v2", (METHOD)rb_cublasDrotg_v2, 5);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDrotm_v2", (METHOD)rb_cublasDrotm_v2, 2);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDgemv_v2", (METHOD)rb_cublasDgemv_v2, 12);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDgbmv_v2", (METHOD)rb_cublasDgbmv_v2, 14);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasStrmv_v2", (METHOD)rb_cublasStrmv_v2, 0);
  rb_define_singleton_method(CuBLAS_v2, "cublasDtrmv_v2", (METHOD)rb_cublasDtrmv_v2, 9);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDtbmv_v2", (METHOD)rb_cublasDtbmv_v2, 10);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDtpmv_v2", (METHOD)rb_cublasDtpmv_v2, 8);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDtrsv_v2", (METHOD)rb_cublasDtrsv_v2, 9);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDtpsv_v2", (METHOD)rb_cublasDtpsv_v2, 8);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDtbsv_v2", (METHOD)rb_cublasDtbsv_v2, 10);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDsymv_v2", (METHOD)rb_cublasDsymv_v2, 1);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDsbmv_v2", (METHOD)rb_cublasDsbmv_v2, 12);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDspmv_v2", (METHOD)rb_cublasDspmv_v2, 10);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDger_v2", (METHOD)rb_cublasDger_v2, 10);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDsyr_v2", (METHOD)rb_cublasDsyr_v2, 8);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDspr_v2", (METHOD)rb_cublasDspr_v2, 7);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDsyr2_v2", (METHOD)rb_cublasDsyr2_v2, 13);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDspr2_v2", (METHOD)rb_cublasDspr2_v2, 9);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDsyrk_v2", (METHOD)rb_cublasDsyrk_v2, 11);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDsyr2k_v2", (METHOD)rb_cublasDsyr2k_v2, 13);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDsyrkx", (METHOD)rb_cublasDsyrkx, 10);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDsymm_v2", (METHOD)rb_cublasDsymm_v2, 10);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDtrsm_v2", (METHOD)rb_cublasDtrsm_v2, 12);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDtrmm_v2", (METHOD)rb_cublasDtrmm_v2, 14);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDgemmBatched", (METHOD)rb_cublasDgemmBatched, 15);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDgeam", (METHOD)rb_cublasDgeam, 13);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDgetrfBatched", (METHOD)rb_cublasDgetrfBatched, 7);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDgetriBatched", (METHOD)rb_cublasDgetriBatched, 9);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDgetrsBatched", (METHOD)rb_cublasDgetrsBatched, 11);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDtrsmBatched", (METHOD)rb_cublasDtrsmBatched, 13);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDmatinvBatched", (METHOD)rb_cublasDmatinvBatched, 8);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDgeqrfBatched", (METHOD)rb_cublasDgeqrfBatched, 8);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDgelsBatched", (METHOD)rb_cublasDgelsBatched, 12);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDdgmm", (METHOD)rb_cublasDdgmm, 10);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDtpttr", (METHOD)rb_cublasDtpttr, 6);
  ...
  rb_define_singleton_method(CuBLAS_v2, "cublasDtrttp", (METHOD)rb_cublasDtrttp, 6);
  ...
  rb_define_singleton_method(CuBLASXT, "cublasXtDestroy", (METHOD)rb_cublasXtDestroy, 1);
  rb_define_singleton_method(CuBLASXT, "cublasXtGetNumBoards", (METHOD)rb_cublasXtGetNumBoards, 1);
  rb_define_singleton_method(CuBLASXT, "cublasXtMaxBoards", (METHOD)rb_cublasXtMaxBoards, 0);
  rb_define_singleton_method(CuBLASXT, "cublasXtDeviceSelect", (METHOD)rb_cublasXtDeviceSelect, 2);
  rb_define_singleton_method(CuBLASXT, "cublasXtSetBlockDim", (METHOD)rb_cublasXtSetBlockDim, 2);
  rb_define_singleton_method(CuBLASXT, "cublasXtGetBlockDim", (METHOD)rb_cublasXtGetBlockDim, 1);
  rb_define_singleton_method(CuBLASXT, "cublasXtGetPinningMemMode", (METHOD)rb_cublasXtGetPinningMemMode, 1);
  rb_define_singleton_method(CuBLASXT, "cublasXtSetPinningMemMode", (METHOD)rb_cublasXtSetPinningMemMode, 2);
  rb_define_singleton_method(CuBLASXT, "cublasXtSetCpuRoutine", (METHOD)rb_cublasXtSetCpuRoutine, 0);
  rb_define_singleton_method(CuBLASXT, "cublasXtSetCpuRatio", (METHOD)rb_cublasXtSetCpuRatio, 4);
  rb_define_singleton_method(CuBLASXT, "cublasXtSgemm", (METHOD)rb_cublasXtSgemm, 0);
  rb_define_singleton_method(CuBLASXT, "cublasXtDgemm", (METHOD)rb_cublasXtDgemm, 14);
  ...
  rb_define_singleton_method(CuBLASXT, "cublasXtDsyrk", (METHOD)rb_cublasXtDsyrk, 11);
  ...
  rb_define_singleton_method(CuBLASXT, "cublasXtDsyr2k", (METHOD)rb_cublasXtDsyr2k, 13);
  ...
  rb_define_singleton_method(CuBLASXT, "cublasXtDtrsm", (METHOD)rb_cublasXtDtrsm, 12);
  ...
  rb_define_singleton_method(CuBLASXT, "cublasXtDsymm", (METHOD)rb_cublasXtDsymm, 13);
  ...
  rb_define_singleton_method(CuBLASXT, "cublasXtDsyrkx", (METHOD)rb_cublasXtDsyrkx, 13);
  ...
  rb_define_singleton_method(CuBLASXT, "cublasXtDspmm", (METHOD)rb_cublasXtDspmm, 12);
  ...
  rb_define_singleton_method(CuBLASXT, "cublasXtDtrmm", (METHOD)rb_cublasXtDtrmm, 14);
  ...
  rb_define_singleton_method(CuSolver, "cusolverDnCpotrf_bufferSize", (METHOD)rb_cusolverDnCpotrf_bufferSize, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnZpotrf_bufferSize", (METHOD)rb_cusolverDnZpotrf_bufferSize, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnSpotrf", (METHOD)rb_cusolverDnSpotrf, 8);
  rb_define_singleton_method(CuSolver, "cusolverDnDpotrf", (METHOD)rb_cusolverDnDpotrf, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnCpotrf", (METHOD)rb_cusolverDnCpotrf, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnZpotrf", (METHOD)rb_cusolverDnZpotrf, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnSpotrs", (METHOD)rb_cusolverDnSpotrs, 9);
  rb_define_singleton_method(CuSolver, "cusolverDnDpotrs", (METHOD)rb_cusolverDnDpotrs, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnCpotrs", (METHOD)rb_cusolverDnCpotrs, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnZpotrs", (METHOD)rb_cusolverDnZpotrs, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnSgetrf_bufferSize", (METHOD)rb_cusolverDnSgetrf_bufferSize, 6);
  rb_define_singleton_method(CuSolver, "cusolverDnDgetrf_bufferSize", (METHOD)rb_cusolverDnDgetrf_bufferSize, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnCgetrf_bufferSize", (METHOD)rb_cusolverDnCgetrf_bufferSize, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnZgetrf_bufferSize", (METHOD)rb_cusolverDnZgetrf_bufferSize, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnSgetrf", (METHOD)rb_cusolverDnSgetrf, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnDgetrf", (METHOD)rb_cusolverDnDgetrf, 8);
  rb_define_singleton_method(CuSolver, "cusolverDnCgetrf", (METHOD)rb_cusolverDnCgetrf, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnZgetrf", (METHOD)rb_cusolverDnZgetrf, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnSlaswp", (METHOD)rb_cusolverDnSlaswp, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnDlaswp", (METHOD)rb_cusolverDnDlaswp, 8);
  rb_define_singleton_method(CuSolver, "cusolverDnClaswp", (METHOD)rb_cusolverDnClaswp, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnZlaswp", (METHOD)rb_cusolverDnZlaswp, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnSgetrs", (METHOD)rb_cusolverDnSgetrs, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnDgetrs", (METHOD)rb_cusolverDnDgetrs, 10);
  rb_define_singleton_method(CuSolver, "cusolverDnCgetrs", (METHOD)rb_cusolverDnCgetrs, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnZgetrs", (METHOD)rb_cusolverDnZgetrs, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnSgeqrf", (METHOD)rb_cusolverDnSgeqrf, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnDgeqrf", (METHOD)rb_cusolverDnDgeqrf, 9);
  rb_define_singleton_method(CuSolver, "cusolverDnCgeqrf", (METHOD)rb_cusolverDnCgeqrf, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnZgeqrf", (METHOD)rb_cusolverDnZgeqrf, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnSormqr", (METHOD)rb_cusolverDnSormqr, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnDormqr", (METHOD)rb_cusolverDnDormqr, 14);
  rb_define_singleton_method(CuSolver, "cusolverDnCunmqr", (METHOD)rb_cusolverDnCunmqr, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnZunmqr", (METHOD)rb_cusolverDnZunmqr, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnSgeqrf_bufferSize", (METHOD)rb_cusolverDnSgeqrf_bufferSize, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnDgeqrf_bufferSize", (METHOD)rb_cusolverDnDgeqrf_bufferSize, 6);
  rb_define_singleton_method(CuSolver, "cusolverDnCgeqrf_bufferSize", (METHOD)rb_cusolverDnCgeqrf_bufferSize, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnZgeqrf_bufferSize", (METHOD)rb_cusolverDnZgeqrf_bufferSize, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnSgebrd", (METHOD)rb_cusolverDnSgebrd, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnDgebrd", (METHOD)rb_cusolverDnDgebrd, 12);
  rb_define_singleton_method(CuSolver, "cusolverDnCgebrd", (METHOD)rb_cusolverDnCgebrd, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnZgebrd", (METHOD)rb_cusolverDnZgebrd, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnSsytrd", (METHOD)rb_cusolverDnSsytrd, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnDsytrd", (METHOD)rb_cusolverDnDsytrd, 11);
  rb_define_singleton_method(CuSolver, "cusolverDnSgebrd_bufferSize", (METHOD)rb_cusolverDnSgebrd_bufferSize, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnDgebrd_bufferSize", (METHOD)rb_cusolverDnDgebrd_bufferSize, 4);
  rb_define_singleton_method(CuSolver, "cusolverDnCgebrd_bufferSize", (METHOD)rb_cusolverDnCgebrd_bufferSize, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnZgebrd_bufferSize", (METHOD)rb_cusolverDnZgebrd_bufferSize, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnSgesvd_bufferSize", (METHOD)rb_cusolverDnSgesvd_bufferSize, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnDgesvd_bufferSize", (METHOD)rb_cusolverDnDgesvd_bufferSize, 4);
  ...
  rb_define_singleton_method(CuSolver, "cusolverDnDsytrf", (METHOD)rb_cusolverDnDsytrf, 9);
  rb_define_singleton_method(CuSolver, "cusolverDnCsytrf", (METHOD)rb_cusolverDnCsytrf, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnZsytrf", (METHOD)rb_cusolverDnZsytrf, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnSsytrf_bufferSize", (METHOD)rb_cusolverDnSsytrf_bufferSize, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnDsytrf_bufferSize", (METHOD)rb_cusolverDnDsytrf_bufferSize, 5);
  rb_define_singleton_method(CuSolver, "cusolverDnCsytrf_bufferSize", (METHOD)rb_cusolverDnCsytrf_bufferSize, 0);
  rb_define_singleton_method(CuSolver, "cusolverDnZsytrf_bufferSize", (METHOD)rb_cusolverDnZsytrf_bufferSize, 0);

  CuRand = rb_define_module_under(RbCUDA, "CuRand");
  rb_define_singleton_method(CuRand, "curandCreateGenerator", (METHOD)rb_curandCreateGenerator, 1);
  rb_define_singleton_method(CuRand, "curandCreateGeneratorHost", (METHOD)rb_curandCreateGeneratorHost, 1);
  rb_define_singleton_method(CuRand, "curandDestroyGenerator", (METHOD)rb_curandDestroyGenerator, 1);
  rb_define_singleton_method(CuRand, "curandGetVersion", (METHOD)rb_curandGetVersion, 0);
  rb_define_singleton_method(CuRand, "curandSetStream", (METHOD)rb_curandSetStream, 2);
  rb_define_singleton_method(CuRand, "curandSetPseudoRandomGeneratorSeed", (METHOD)rb_curandSetPseudoRandomGeneratorSeed, 2);
  rb_define_singleton_method(CuRand, "curandSetGeneratorOffset", (METHOD)rb_curandSetGeneratorOffset, 2);
  rb_define_singleton_method(CuRand, "curandSetGeneratorOrdering", (METHOD)rb_curandSetGeneratorOrdering, 2);
  rb_define_singleton_method(CuRand, "curandSetQuasiRandomGeneratorDimensions", (METHOD)rb_curandSetQuasiRandomGeneratorDimensions, 2);
  rb_define_singleton_method(CuRand, "curandGenerate", (METHOD)rb_curandGenerate, 3);
  rb_define_singleton_method(CuRand, "curandGenerateLongLong", (METHOD)rb_curandGenerateLongLong, 3);
  rb_define_singleton_method(CuRand, "curandGenerateUniform", (METHOD)rb_curandGenerateUniform, 3);
  rb_define_singleton_method(CuRand, "curandGenerateUniformDouble", (METHOD)rb_curandGenerateUniformDouble, 3);
  rb_define_singleton_method(CuRand, "curandGenerateNormal", (METHOD)rb_curandGenerateNormal, 5);
  rb_define_singleton_method(CuRand, "curandGenerateNormalDouble", (METHOD)rb_curandGenerateNormalDouble, 5);
  rb_define_singleton_method(CuRand, "curandGenerateLogNormal", (METHOD)rb_curandGenerateLogNormal, 5);
  rb_define_singleton_method(CuRand, "curandGenerateLogNormalDouble", (METHOD)rb_curandGenerateLogNormalDouble, 5);
  rb_define_singleton_method(CuRand, "curandCreatePoissonDistribution", (METHOD)rb_curandCreatePoissonDistribution, 1);
  rb_define_singleton_method(CuRand, "curandDestroyDistribution", (METHOD)rb_curandDestroyDistribution, 1);
  rb_define_singleton_method(CuRand, "curandGeneratePoisson", (METHOD)rb_curandGeneratePoisson, 4);
  rb_define_singleton_method(CuRand, "curandGeneratePoissonMethod", (METHOD)rb_curandGeneratePoissonMethod, 0);
  rb_define_singleton_method(CuRand, "curandGenerateSeeds", (METHOD)rb_curandGenerateSeeds, 1);
  rb_define_singleton_method(CuRand, "curandGetDirectionVectors32", (METHOD)rb_curandGetDirectionVectors32, 0);
  rb_define_singleton_method(CuRand, "curandGetScrambleConstants32", (METHOD)rb_curandGetScrambleConstants32, 1);
  rb_define_singleton_method(CuRand, "curandGetDirectionVectors64", (METHOD)rb_curandGetDirectionVectors64, 0);
  rb_define_singleton_method(CuRand, "curandGetScrambleConstants64", (METHOD)rb_curandGetScrambleConstants64, 1);
